    ...
    <section className="container w-full text-gray-700 flex justify-stretch items-center sm:my-10">
      <div className="flex flex-col justify-center items-center w-full gap-4">
        ...
        <div className="items-stretch max-w-6xl w-full bg-white rounded-2xl shadow-lg p-6 flex flex-col md:flex-row gap-6">
          ...
          <video controls className="w-full md:w-1/3 h-80 rounded-xl shadow-md">
            <source
              src="https://res.cloudinary.com/dt4pkrj5j/video/upload/v1756007252/Testimonio-alfonso_dfywcd.mp4"
              type="video/mp4"
            />
            Tu navegador no soporta video.
          </video>
          ...
          <div className="flex flex-col text-left md:w-2/3 justify-around">
            <div>
              <p className="text-lg italic text-gray-700 mb-4">
                “Después de sufrir un ACV, pensé que mi recuperación sería lenta
                y limitada. Pero al empezar a tomar Colágeno y Rio Vida, sentí
                cómo mi cuerpo iba recobrando fuerza y energía día tras día.
                Este testimonio es la prueba de que, con determinación y los
                productos adecuados, es posible transformar tu bienestar y
                recuperar la vitalidad que creías perdida. Espero que mi
                experiencia inspire a otros a dar el primer paso hacia su propia
