            ...
            <div className="flex items-center justify-stretch flex-row py-10 md:px-16 px-4 gap-4 sm:gap-0 w-full">
                <div className="w-[50%] sm:w-[70%] h-full flex">
                        <div className="w-full sm:w-[80%] gap-6 flex flex-col">
                            <p className='text-xs sm:text-2xl text-center'>Complementa tu dieta y promueve el bienestar general de tu organismo con este suplemento dietario exclusivo de 4Life a base de L-Glutamina y otros aminoácidos que complementan tu dieta y promueven el bienestar de tu organismo</p>
